...
%
A small example is used to illustrate these metrics in a single scene that uses a MAS framework, e.g. Jason~\cite{bordini2005jason}, to generate interesting tests. A full description of the assessment is given in Section~\ref{Test Case}. 
%
...
\todo[inline]{Remove this list and refer to the table}
\begin{itemize}
...
(Innovate UK, Grant no.s 103703 and 103288 respectively). 
