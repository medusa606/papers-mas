...
%------------ Results Discussion ---------------
\section{Results}
The results section is split into 5 parts; Accuracy is the ratio of successful tests the agents generated as a ratio of all test runs, Score is a measure of how natural the agents behaved, Combined Score combines accuracy with score, Time is how long the agents took to generate the test in both simulation ticks and CPU time. Both Score and Time have distributions associated with them and as such 95\% confidence intervals are provided.
